...
Contains the component categories and components from the original components-config.ts
"""

# Component Categories matching COMPONENT_CATEGORIES from components-config.ts
SEED_CATEGORIES = {
    "infrastructure": {
        "name": "Infrastructure",
        "icon": "fas fa-server",
...
# Components matching COMPONENTS from components-config.ts
SEED_COMPONENTS = {
    "gpt-4": {
        "name": "GPT-4",
        "icon": "🟢",
